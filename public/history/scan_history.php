...
<?php if ($result->num_rows === 0): ?>
    <div class="empty-state">
        ...
        <a href="/WebCheck360-backup/WebCheck360/public/scanner.php" class="primary-btn">Run Your First Scan</a>
    </div>
<?php else: ?>
...
<tr>
    ...
    <td>
        <a href="/WebCheck360-backup/WebCheck360/public/view_scan.php?id=<?= $row['id'] ?>" class="view-btn">
            View Details
        </a>
    </td>
</tr>
